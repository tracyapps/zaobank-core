...
class ZAOBank_Appreciations {
	...
	private static function format_appreciation_data($appreciation) {
		...
		return array(
			...
			'from_user_pronouns' => get_user_meta($appreciation->from_user_id, 'user_pronouns', true),
			...
			'to_user_pronouns' => get_user_meta($appreciation->to_user_id, 'user_pronouns', true),
