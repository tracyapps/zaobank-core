...
class ZAOBank_Exchanges {
	...
	public static function get_worked_with_summary($user_id) {
		...
		return array_map(function($row) use ($latest_notes) {
			...
			return array(
				...
				'other_user_pronouns' => get_user_meta($other_id, 'user_pronouns', true),
	...
	private static function format_exchange_data($exchange) {
		...
		return array(
			...
			'provider_pronouns' => get_user_meta($provider_id, 'user_pronouns', true),
			...
			'requester_pronouns' => get_user_meta($requester_id, 'user_pronouns', true),
